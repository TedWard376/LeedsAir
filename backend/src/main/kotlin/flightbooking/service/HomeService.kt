...
object HomeService {
    ...
    private val BestOffers = listOf(
        ...
        Offer("Barcelona Sun", "From $110", 110.0, "USD", "BCN", "https://images.unsplash.com/photo-1583422409516-2895a77efded?w=400", "Park Güell in Barcelona", "Return", ariaLabel = "Special offer: Barcelona Sun, Return flight from 110 USD to BCN"),
