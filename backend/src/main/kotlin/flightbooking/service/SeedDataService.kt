...
object SeedDataService {
            ...
            val demoUsers =
                listOf(
                    ...
                    DemoBookingSeed(
                        "Sophie",
                        "Walker",
                        "sophie.walker@demo.leedsair.local",
                        "cancelled",
                        142.99,
                        emptyList(),
                        "Family emergency before departure.",
                    ),
                    DemoBookingSeed(
                        "Daniel",
                        "Morgan",
                        "daniel.morgan@demo.leedsair.local",
                        "confirmed",
                        268.40,
                        listOf("seat_change"),
                        null,
                    ...
                    DemoBookingSeed(
                        "Aisha",
                        "Rahman",
                        "aisha.rahman@demo.leedsair.local",
                        "confirmed",
                        512.75,
                        listOf("date_change"),
                        null,
                    ...
                    DemoBookingSeed(
                        "Lucas",
                        "Bennett",
                        "lucas.bennett@demo.leedsair.local",
                        "confirmed",
                        221.10,
                        listOf("bag_addition"),
                        null,
                    ...
                    DemoBookingSeed(
                        "Grace",
                        "Murphy",
                        "grace.murphy@demo.leedsair.local",
                        "cancelled",
                        167.35,
                        emptyList(),
                    ...
                    DemoBookingSeed(
                        "Leo",
                        "Turner",
                        "leo.turner@demo.leedsair.local",
                        "confirmed",
                        198.75,
                        listOf("seat_change", "special_assistance"),
                        null,
                    ),
                )
    ...
    private fun seedVisibleDemoCustomerBookings() {
        transaction {
            ...
            val userId =
                existingUser?.get(UsersTable.id)
                    ?: UsersTable.insert { row ->
                        row[firstName] = "Jamie"
                        row[lastName] = "Carter"
                        row[email] = demoEmail
        ...
        transaction {
            ...
            schedules.forEach { schedule ->
                ...
                FlightSchedulesTable.insert { row ->
                    ...
                    row[FlightSchedulesTable.durationMinutes] =
    ...
    private fun seedScheduledFlights() {
        transaction {
            ...
            scheduleRows.forEach { scheduleRow ->
                ...
                val aircraftId =
                    aircraftIdsByKey.getOrPut(aircraftKey(aircraftModel, totalSeats)) {
    ...
    private fun createAircraftWithSeats(
        modelName: String,
        totalSeats: Int,
    ): Int {
    ...
    private fun DayOfWeek.toOperateDaysIndex(): Int =
        when (this) {
            DayOfWeek.MONDAY -> 0
            DayOfWeek.TUESDAY -> 1
    ...
    private fun aircraftKey(
        model: String?,
        totalSeats: Int,
    ): String = "${model.orEmpty().trim()}::$totalSeats"
